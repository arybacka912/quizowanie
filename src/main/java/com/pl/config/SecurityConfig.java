...
//
//	@Bean
//	public PersistentTokenRepository persistentTokenRepository() { //trwałe tokeny
...
//
//	@Autowired
//	public void configureGlobal(AuthenticationManagerBuilder auth, UserDetailsService userDetailsService, //odkodowywanie password'a
